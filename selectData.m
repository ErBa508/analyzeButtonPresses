...
elseif formatType == 2
    ...
    [rawData, splitData, numTrials, index] = importfile(pathname, filename); % importfile is a modified Matlab generated function that separates data into a set of columns
